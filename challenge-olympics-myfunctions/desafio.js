...
const paisAfricano = olympicsMedalTable.find((cowntry) => cowntry.id === 10);
console.log(paisAfricano);
...
const medalhasPorPais = olympicsMedalTable.reduce(
  (cowntry) => cowntry.gold + cowntry.silver + cowntry.bronze,
);
console.log(`${cowntry} tem ${medalhasPorPais} medalhas`);
...
const paisesCom30MedalhasNoMinimo = olympicsMedalTable.filter(
  (cowntry) => cowntry.gold + cowntry.silver + cowntry.bronze >= 30,
);
console.log(paisesCom30MedalhasNoMinimo);
...
const paisesComPeloMenos20MedalhasDeOUro = olympicsMedalTable.find(
  (continent) => continent.gold >= 20,
);
console.log(paisesComPeloMenos20MedalhasDeOUro);
